...
# read dataset
X_train_df = pd.read_csv("/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/X_train_integrate_2_imp.csv")
X_test_df = pd.read_csv("/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/X_test_integrate_2_imp.csv")
Y_train_df = pd.read_csv("/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/y_train_integrate_2.csv")
Y_test_df =  pd.read_csv("/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/y_test_integrate_2.csv")
...
optimizer = tt.optim.Adam(lr=5e-3, weight_decay=1e-3)
model = CoxPH(net, optimizer)

# callbacks
cindex_cb = CIndexCallback(model, X_train, y_train, X_val, y_val)
callbacks = [tt.callbacks.EarlyStopping(patience=8), cindex_cb]
