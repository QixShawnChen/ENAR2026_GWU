...
# Paths
# --------------------
X_TRAIN_PATH = "/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/X_train_integrate_1cli_imp.csv"
X_TEST_PATH  = "/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/X_test_integrate_1cli_imp.csv"
Y_TRAIN_PATH = "/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/y_train_integrate_1cli.csv"
Y_TEST_PATH  = "/Users/liyajie/Downloads/Program/ENAR 2026 DataFest/data/Test_Train_15_85/y_test_integrate_1cli.csv"
...
num_cols = num_base + mrna_cols + methy_cols
...
print("Before PCA:", X_tr.shape, X_te.shape)
print("After  PCA:", X_tr_pca.shape, X_te_pca.shape)
...
for p in param_grid:
    mean_c, sd_c = rsf_cv(X_tr_pca, dur_train, ev_train, p)
...
rsf_final.fit(X_tr_pca, y_tr)

# --------------------
# Test C-index
# --------------------
risk_test = rsf_final.predict(X_te_pca)
...
sf = rsf_final.predict_survival_function(X_te_pca, return_array=False)
